...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(135, 206, 235)",
        "c-primary-dark-100": "rgb(122,185,212)",
        "c-primary-dark-100-alpha-100": "rgba(122, 185, 212, 0.90)",
        "c-primary-alpha-100": "rgba(135, 206, 235, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(122, 185, 212, 0.80)",
        "c-primary-alpha-200": "rgba(135, 206, 235, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(122, 185, 212, 0.70)",
        "c-primary-alpha-300": "rgba(135, 206, 235, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(122, 185, 212, 0.60)",
        "c-primary-alpha-400": "rgba(135, 206, 235, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(122, 185, 212, 0.50)",
        "c-primary-alpha-500": "rgba(135, 206, 235, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(122, 185, 212, 0.40)",
        "c-primary-alpha-600": "rgba(135, 206, 235, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(122, 185, 212, 0.30)",
        "c-primary-alpha-700": "rgba(135, 206, 235, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(122, 185, 212, 0.20)",
        "c-primary-alpha-800": "rgba(135, 206, 235, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(122, 185, 212, 0.10)",
        "c-primary-alpha-900": "rgba(135, 206, 235, 0.10)",
        "c-primary-dark-200": "rgb(110,167,191)",
        "c-primary-dark-200-alpha-100": "rgba(110, 167, 191, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(110, 167, 191, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(110, 167, 191, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(110, 167, 191, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(110, 167, 191, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(110, 167, 191, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(110, 167, 191, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(110, 167, 191, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(110, 167, 191, 0.10)",
        "c-primary-dark-300": "rgb(99,150,172)",
        "c-primary-dark-300-alpha-100": "rgba(99, 150, 172, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(99, 150, 172, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(99, 150, 172, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(99, 150, 172, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(99, 150, 172, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(99, 150, 172, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(99, 150, 172, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(99, 150, 172, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(99, 150, 172, 0.10)",
        "c-primary-dark-400": "rgb(89,135,155)",
        "c-primary-dark-400-alpha-100": "rgba(89, 135, 155, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(89, 135, 155, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(89, 135, 155, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(89, 135, 155, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(89, 135, 155, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(89, 135, 155, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(89, 135, 155, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(89, 135, 155, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(89, 135, 155, 0.10)",
        "c-primary-dark-500": "rgb(80,122,140)",
        "c-primary-dark-500-alpha-100": "rgba(80, 122, 140, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(80, 122, 140, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(80, 122, 140, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(80, 122, 140, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(80, 122, 140, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(80, 122, 140, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(80, 122, 140, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(80, 122, 140, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(80, 122, 140, 0.10)",
        "c-primary-dark-600": "rgb(72,110,126)",
        "c-primary-dark-600-alpha-100": "rgba(72, 110, 126, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(72, 110, 126, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(72, 110, 126, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(72, 110, 126, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(72, 110, 126, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(72, 110, 126, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(72, 110, 126, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(72, 110, 126, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(72, 110, 126, 0.10)",
        "c-primary-dark-700": "rgb(65,99,113)",
        "c-primary-dark-700-alpha-100": "rgba(65, 99, 113, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(65, 99, 113, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(65, 99, 113, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(65, 99, 113, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(65, 99, 113, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(65, 99, 113, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(65, 99, 113, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(65, 99, 113, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(65, 99, 113, 0.10)",
        "c-primary-dark-800": "rgb(59,89,102)",
        "c-primary-dark-800-alpha-100": "rgba(59, 89, 102, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(59, 89, 102, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(59, 89, 102, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(59, 89, 102, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(59, 89, 102, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(59, 89, 102, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(59, 89, 102, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(59, 89, 102, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(59, 89, 102, 0.10)",
        "c-primary-dark-900": "rgb(53,80,92)",
        "c-primary-dark-900-alpha-100": "rgba(53, 80, 92, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(53, 80, 92, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(53, 80, 92, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(53, 80, 92, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(53, 80, 92, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(53, 80, 92, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(53, 80, 92, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(53, 80, 92, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(53, 80, 92, 0.10)",
        "c-primary-dark-1000": "rgb(48,72,83)",
        "c-primary-dark-1000-alpha-100": "rgba(48, 72, 83, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(48, 72, 83, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(48, 72, 83, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(48, 72, 83, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(48, 72, 83, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(48, 72, 83, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(48, 72, 83, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(48, 72, 83, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(48, 72, 83, 0.10)",
        "c-primary-light-100": "rgb(159,216,239)",
        "c-primary-light-100-alpha-100": "rgba(159, 216, 239, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(159, 216, 239, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(159, 216, 239, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(159, 216, 239, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(159, 216, 239, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(159, 216, 239, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(159, 216, 239, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(159, 216, 239, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(159, 216, 239, 0.10)",
        "c-primary-light-200": "rgb(178,224,242)",
        "c-primary-light-200-alpha-100": "rgba(178, 224, 242, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(178, 224, 242, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(178, 224, 242, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(178, 224, 242, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(178, 224, 242, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(178, 224, 242, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(178, 224, 242, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(178, 224, 242, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(178, 224, 242, 0.10)",
        "c-primary-light-300": "rgb(193,230,245)",
        "c-primary-light-300-alpha-100": "rgba(193, 230, 245, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(193, 230, 245, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(193, 230, 245, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(193, 230, 245, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(193, 230, 245, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(193, 230, 245, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(193, 230, 245, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(193, 230, 245, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(193, 230, 245, 0.10)",
        "c-primary-light-400": "rgb(205,235,247)",
        "c-primary-light-400-alpha-100": "rgba(205, 235, 247, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(205, 235, 247, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(205, 235, 247, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(205, 235, 247, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(205, 235, 247, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(205, 235, 247, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(205, 235, 247, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(205, 235, 247, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(205, 235, 247, 0.10)",
        "c-primary-light-500": "rgb(215,239,249)",
        "c-primary-light-500-alpha-100": "rgba(215, 239, 249, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(215, 239, 249, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(215, 239, 249, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(215, 239, 249, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(215, 239, 249, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(215, 239, 249, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(215, 239, 249, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(215, 239, 249, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(215, 239, 249, 0.10)",
        "c-primary-light-600": "rgb(223,242,250)",
        "c-primary-light-600-alpha-100": "rgba(223, 242, 250, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(223, 242, 250, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(223, 242, 250, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(223, 242, 250, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(223, 242, 250, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(223, 242, 250, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(223, 242, 250, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(223, 242, 250, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(223, 242, 250, 0.10)",
        "c-primary-light-700": "rgb(229,245,251)",
        "c-primary-light-700-alpha-100": "rgba(229, 245, 251, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(229, 245, 251, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(229, 245, 251, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(229, 245, 251, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(229, 245, 251, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(229, 245, 251, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(229, 245, 251, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(229, 245, 251, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(229, 245, 251, 0.10)",
        "c-primary-light-800": "rgb(234,247,252)",
        "c-primary-light-800-alpha-100": "rgba(234, 247, 252, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(234, 247, 252, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(234, 247, 252, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(234, 247, 252, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(234, 247, 252, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(234, 247, 252, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(234, 247, 252, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(234, 247, 252, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(234, 247, 252, 0.10)",
        "c-primary-light-900": "rgb(238,249,253)",
        "c-primary-light-900-alpha-100": "rgba(238, 249, 253, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(238, 249, 253, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(238, 249, 253, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(238, 249, 253, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(238, 249, 253, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(238, 249, 253, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(238, 249, 253, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(238, 249, 253, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(238, 249, 253, 0.10)",
